...
- [ ] Mengetahui dan menggunakan sistem untuk mengendalikan revisi, yaitu Git and GitHub
- [ ] Memahahami perencanaan dan manajemen dalam pembuatan web
- [ ] Memahami pair development/coding/programming
- [ ] Melakukan pencatatan pribadi atau blogging

## Tuesday

- [ ] Mengenali lebih jelas apa itu Internet, the Web, browser, website, dan aplikasi web
- [ ] Melatih lebih baik dalam menggunakan command line

## Wednesday

- [ ] Mempelajari dan menggunakan teknik wireframing
- [ ] Menggunakan berbagai elemen dasar HTML yang perlu kamu ketahui dan kuasai
- [ ] Membuat HTML form dengan menggunakan berbagai elemen terkait
